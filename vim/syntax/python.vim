...
" Disable def and class as keyword as that will take precedence over region
" preventing the fold to be defined
"syn keyword pythonStatement	class def nextgroup=pythonFunction skipwhite
syn match pythonStatement "^\s*\%(def\|class\)\s" nextgroup=pythonFunction skipwhite
syn region pythonFunctionFold start="^\z(\s*\)\%(def\|class\)\>" end="\ze\%(\s*\n\)\+\%(\z1\s\)\@!." fold transparent
